...
from disnake.ext.jishaku.hljs import get_language, guess_file_traits
from disnake.ext.jishaku.types import BotT, ContextA
...
def button_either_arg(
    a: MaybeButton[T], b: MaybeButton[T]
...
class PaginatorInterface(ui.View):  # pylint: disable=too-many-instance-attributes
    ...
    .. code:: python3
        ...
        from disnake.ext.jishaku.paginators import PaginatorInterface
    ...
    async def button_start(
        self, a: MaybeButton["PaginatorInterface"], b: MaybeButton["PaginatorInterface"]
    ...
    if typing.TYPE_CHECKING or hasattr(ui, "TextInput"):
        ...
        class PageChangeModal(ui.Modal, title="Go to page"):
            ...
            page_number: ui.TextInput[ui.Modal] = ui.TextInput(
                label="Page number", style=disnake.TextStyle.short
            )

            def __init__(
                self, interface: "PaginatorInterface", *args: typing.Any, **kwargs: typing.Any
            ):
        ...
        @ui.button(
            label="\N{RIGHTWARDS ARROW WITH HOOK} \u200b Go to page",
            style=disnake.ButtonStyle.primary,
        )
        async def button_goto(
            self, a: MaybeButton["PaginatorInterface"], b: MaybeButton["PaginatorInterface"]
        ):  # pylint: disable=unused-argument
    ...
    @ui.button(
        label="\N{BLACK SQUARE FOR STOP} \u200b Close paginator", style=disnake.ButtonStyle.danger
    )
