...
class GuildFeature(Feature):
    ...
    def apply_overwrites(
        permissions: typing.Dict[str, typing.Tuple[bool, str]], allow: int, deny: int, name: str
    ):
        """
    ...
    async def jsk_permtrace(
        ...
        *targets: typing.Union[disnake.Member, disnake.Role],
        ...
        # Construct embed
        description = (
            f"This is the permissions calculation for the following targets in {channel.mention}:\n"
        )
