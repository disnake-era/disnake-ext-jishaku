...
from disnake.ext.jishaku.repl.scope import Scope
from disnake.ext.jishaku.repl.walkers import KeywordTransformer
...
async def _repl_coroutine({{0}}):
    ...
    try:
        import disnake.ext.jishaku as jishaku
    except ImportError:
...
class AsyncCodeExecutor:  # pylint: disable=too-few-public-methods
    ...
    def function(
        ...
        ...,
        typing.Union[typing.Awaitable[typing.Any], typing.AsyncGenerator[typing.Any, typing.Any]],
    ]:
        """
        ...
        self._function = (
            self.scope.locals.get("_repl_coroutine") or self.scope.globals["_repl_coroutine"]
        )
